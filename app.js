...
/* Вес нигде не показывается — ни в корзине, ни в чате. Считается только
   внутри: уходит боту, чтобы тот посчитал себестоимость и прибыль. */
...
function productCard(p){
 ...
 <span class="original-badge">✓ ${tr().original}</span>
...
function renderCart(){
 ...
 document.querySelector('#delivery').textContent=tr().deliveryPaid;
